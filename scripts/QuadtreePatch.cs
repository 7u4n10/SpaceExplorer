...
public partial class QuadtreePatch : Node3D
{
	...
	[Export] public float[] LodDistanceThresholds = new float[] { 200f, 100f, 50f, 25f };
	...
	public override void _Process(double delta)
	{
		...
		if (children == null && lodIndex != currentLODIndex)
		{
			try
			{
				GD.Print($"[QuadtreePatch] Generating mesh at LOD {LODResolutions[lodIndex]}");
				...
				GD.Print($"[DEBUG] Mesh AABB: {aabb.Position}, {aabb.Size}");
